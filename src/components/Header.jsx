...
const Header = () => {
  ...
  // Services list with their route paths
  const services = [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8 items-center">
            <Link
              to="/"
              className="text-black hover:text-yellow-500 font-bold text-md transition-colors duration-200"
            >
              Home
            </Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-200">
            <div className="flex flex-col space-y-4 pt-4">
              <Link
                to="/"
                className="text-black hover:text-yellow-500 font-medium text-sm transition-colors duration-200 py-2"
